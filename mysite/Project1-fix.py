...
def play(grid, p1, p2):
    ...
    while done(grid) != True:
        ...
        cord = raw_input('Player 1 enter coordinates: ')
        move(cord, grid, p1)
        ...
        if done(grid):
            ...
            break
        # Player 2
        cord = raw_input('Player 2 enter coordinates: ')
        move(cord, grid, p2)
...
def move(cord, grid, player):
    ...
    if grid[int(cordx)][int(cordy)] != '.':
        ...
        cord = raw_input("Player" + ' ' + player.name + ' ' + "please enter different coordinates: ")
